...
const binName = isWindows ? 'myyoda.exe' : 'myyoda'
...
console.log(`${color.cyan}[build:cli]${color.reset} 编译 myyoda CLI → ${color.dim}${outFile}${color.reset}`)
