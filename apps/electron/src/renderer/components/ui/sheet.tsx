...
const sheetVariants = cva(
  ...
  "fixed z-[100] gap-4 bg-dialog text-dialog-foreground p-6 shadow-xl transition ease-out data-[state=closed]:duration-base data-[state=open]:duration-slow data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
