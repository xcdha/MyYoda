 ...
 *
 * 数据来源：~/.myyoda/agent-sessions/{id}.jsonl 里最后一条带 usage 的消息。
 * 优先级：
...
import { calculateContextUsageRatio, inferAgentSdkContextWindow, inferContextWindow } from '@myyoda/shared'
import type { SDKAssistantMessage, SDKResultMessage } from '@myyoda/shared'
